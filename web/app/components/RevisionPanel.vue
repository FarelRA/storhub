...
<template>
  <section class="space-y-3">
    ...
    <ul v-else class="flex max-h-72 flex-col gap-1.5 overflow-y-auto pr-1">
      <li v-for="revision in revisions" :key="revision.commit_sha" class="card px-3 py-2">
        ...
        <p v-if="revision.message" class="mt-1 line-clamp-2 text-xs text-mist">{{ revision.message }}</p>
