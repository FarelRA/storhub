...
- how to expose StorHub over HTTP with `storhub.DefaultRESTOptions`
  and `storhub.NewRESTHandler`
- how to keep the handler unauthenticated by leaving `RESTOptions.Auth` unset
