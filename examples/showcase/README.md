...
- how to create a client with `storhub.NewStorHubWithContext`
- how the main storage, filesystem, POSIX, revision, and FUSE APIs fit together in one workflow
...
6. previews FUSE setup through `storhub.DefaultFUSEOptions` and `(*StorHub).NewFUSE` (no mount)
